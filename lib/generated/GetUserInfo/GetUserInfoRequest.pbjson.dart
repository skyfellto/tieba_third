  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.tieba.getUserInfo.GetUserInfoRequestData',
      '10': 'data'
    },
  ],
};
...
final $typed_data.Uint8List getUserInfoRequestDescriptor = $convert.base64Decode(
    'ChJHZXRVc2VySW5mb1JlcXVlc3QSPQoEZGF0YRgBIAEoCzIpLnRpZWJhLmdldFVzZXJJbmZvLk'
    'dldFVzZXJJbmZvUmVxdWVzdERhdGFSBGRhdGE=');
