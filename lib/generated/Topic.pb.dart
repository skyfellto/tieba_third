...
class Topic extends $pb.GeneratedMessage {
  factory Topic({
    ...
    final result = create();
    if (isLpost != null) result.isLpost = isLpost;
    if (topicType != null) result.topicType = topicType;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(1, _omitFieldNames ? '' : 'isLpost')
    ..aI(2, _omitFieldNames ? '' : 'topicType')
  ...
  @$pb.TagNumber(1)
  $core.int get isLpost => $_getIZ(0);
  @$pb.TagNumber(1)
  set isLpost($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
  $core.bool hasIsLpost() => $_has(0);
  @$pb.TagNumber(1)
  void clearIsLpost() => $_clearField(1);

  @$pb.TagNumber(2)
  $core.int get topicType => $_getIZ(1);
  @$pb.TagNumber(2)
  set topicType($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  $core.bool hasTopicType() => $_has(1);
  @$pb.TagNumber(2)
  void clearTopicType() => $_clearField(2);
