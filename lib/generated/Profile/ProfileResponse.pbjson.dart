...
const ProfileResponse$json = {
  ...
  '2': [
    {'1': 'error', '3': 1, '4': 1, '5': 11, '6': '.tieba.Error', '10': 'error'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.tieba.profile.ProfileResponseData',
      '10': 'data'
    },
  ],
};
...
final $typed_data.Uint8List profileResponseDescriptor = $convert.base64Decode(
    'Cg9Qcm9maWxlUmVzcG9uc2USIgoFZXJyb3IYASABKAsyDC50aWViYS5FcnJvclIFZXJyb3ISNg'
    'oEZGF0YRgCIAEoCzIiLnRpZWJhLnByb2ZpbGUuUHJvZmlsZVJlc3BvbnNlRGF0YVIEZGF0YQ==');
