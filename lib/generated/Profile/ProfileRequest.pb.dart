...
//
// Generated from Profile/ProfileRequest.proto.
...
class ProfileRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.ProfileRequestData>(1, _omitFieldNames ? '' : 'data',
        subBuilder: $0.ProfileRequestData.create)
  ...
  @$pb.TagNumber(1)
  $0.ProfileRequestData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($0.ProfileRequestData value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => $_clearField(1);
  @$pb.TagNumber(1)
  $0.ProfileRequestData ensureData() => $_ensure(0);
}
