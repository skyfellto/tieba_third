...
class ManagerApplyInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(5, _omitFieldNames ? '' : 'managerApplyStatus')
  ...
  @$pb.TagNumber(5)
  $core.int get managerApplyStatus => $_getIZ(4);
  @$pb.TagNumber(5)
  set managerApplyStatus($core.int value) => $_setSignedInt32(4, value);
  @$pb.TagNumber(5)
  $core.bool hasManagerApplyStatus() => $_has(4);
  @$pb.TagNumber(5)
  void clearManagerApplyStatus() => $_clearField(5);
}
